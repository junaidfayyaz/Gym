...
// Force IPv4 first to eliminate 30s IPv6 DNS lookup timeout on Netlify / Serverless
...
export async function connectToDatabase() {
  ...
  if (!cached.promise) {
    const opts = {
      ...
      family: 4, // Force IPv4 family connection
    };
    ...
    cached.promise = (async () => {
      ...
      if (mongoUri) {
        ...
        console.log('✅ MongoDB Atlas Connected via IPv4');

        // Run seed check at most once per process lifespan (non-blocking)
